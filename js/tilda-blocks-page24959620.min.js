...
function t602_init(recid) {
	...
	window.addEventListener(
		...
		t_throttle(function () {
			...
			var scrollPercent =
				(windowScrollTop / (documentHeight - windowHeight)) * 100;
...
function t270_scrollToEl(hash, offset) {
	...
	var canSmoothScroll =
		window.CSS && window.CSS.supports('scroll-behavior', 'smooth');
	if (
		window.isMobile &&
		canSmoothScroll &&
