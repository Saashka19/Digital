...
function t_zeroForms__createForm(t, e, r, o) {
	...
	c.classList.add('js-successbox'),
		c.classList.add('t-form__successbox'),
		c.classList.add('t-text'),
		c.classList.add('t-text_sm'),
		(c.style.display = 'none'),
		(c.innerHTML = n.formmsgsuccess),
	...
	var d = {
		...
		u = t_zeroForms__generateInputsBlock(t, o, r, n, d);
	s.insertAdjacentElement('beforeend', u);
	var m = o.getAttribute('data-elem-id'),
		p = n.formbottomtext && n.formbottomtext.trim(),
		f;
	if (p) {
		var b = document.createElement('div');
		(b.style.textAlign = 'center' === n.buttonalign ? 'center' : 'left'),
			(b.style.color = d.color),
			(b.style.fontWeight = d.fontWeight),
			(b.style.fontFamily = d.fontFamily),
			(b.style.marginTop = '15px'),
			(b.style.fontSize = '13px');
		var g = t_zeroForms__getBottomText(m, n, t, o, p);
		b.appendChild(g), s.insertAdjacentElement('beforeend', b);
	}
	if (
		...
		t_zeroForms__createInputPlaceholderStyles(m, n, t, o),
		'h' === n.inputpos || 'zero' === e)
	) {
		var v = 't-zero-form-h-styles';
	...
	t_zeroForms__setScriptOrStyle(
		...
		'y' === n.inputsstyle2 &&
			t_zeroForms__onRender(o, !1, function () {
				t_zeroForms__animateInputs(o, n, t, m);
			});
	var y = 't-zero-form-font-family-' + t + '-' + m;
	if (n.fieldfontfamily) {
		var h = t_zeroForms__createSelector(t, m, ''),
			z = [
				'input[type="text"]',
				'input[type="tel"]',
				'input[type="url"]',
		...
		t_zeroForms__setScriptOrStyle(
			y,
			'',
			(z = z.reduce(function (t, e, r) {
				return (
					(t += h + '.t-input-block ' + e), r !== z.length - 1 && (t += ', '), t
				);
			}, '')) +
				' {font-family: "' +
				n.fieldfontfamily +
		...
		x && x.parentElement && x.parentElement.removeChild(x);
	}
	if (
		...
		var E = document.querySelectorAll('[data-record-type="803"]');
...
function t_zeroForms__parseIntoElement(t, e, r, o, n, i) {
	...
	switch ((p.classList.add('t-input-block'), r.li_type)) {
		...
		case 'sb':
			...
			if (
				((f = t_zeroForms__createSelect(r, d, m, b)),
				(o.inputsstyle && o.inputelscolor) || d.color)
			) {
				var g = document.createElement('style'),
					v = t_zeroForms__createSelector(t, i, '.t-select__wrapper:after'),
					F = o.inputsstyle ? o.inputelscolor : d.color;
				(g.textContent = v + '{border-top-color:' + F + ';}'),
					f.insertAdjacentElement('beforeend', g);
			}
			break;
		case 'rd':
			var y = 'cb' === r.li_radcb ? 'checkbox' : 'radio';
			(f = t_zeroForms__createRadio(r, o, m, u, y, t, i)),
				t_zeroForms__setIndicatorStyles(t, i, o.inputelscolor, y, f);
			var h = t ? '#rec' + t + ' ' : '';
			t_zeroForms__setScriptOrStyle(
				't-zero-form-fieldset-' + t,
				'',
				(h += 'fieldset {padding: 0; margin: 0; border: none;}'),
				'style',
				e
			),
				'checkbox' === y &&
		...
		case 'ri':
			...
			break;
		case 'cb':
			(f = t_zeroForms__createCheckbox(r, u, o, m)),
				t_zeroForms__setIndicatorStyles(t, i, o.inputelscolor, 'checkbox', f);
			break;
		case 'uw':
		...
		case 'uc':
			...
			var z = 'UPLOADCARE_LOCALE ="' + r.li_inp + '";';
			t_zeroForms__setScriptOrStyle(
				't-zero-uploadcare-' + i,
				'',
				(z += 'UPLOADCARE_TABS = "all";'),
				'script',
				!1
			);
			break;
		...
		case 'tm':
			...
			break;
		case 'qn':
			(f = t_zeroForms__createQuantityField(r, d, o.inputelscolor, m)),
		...
		case 'rg':
			if (
				((f = t_zeroForms__createQuantityRange(r, d, o, m)), o.inputelscolor)
			) {
		...
		case 'fr':
			if (
				((f = t_zeroForms__createCalculation(r, d, m, n)), o.inputfrbgcolor)
			) {
				...
				(S.textContent =
					...
					f.insertAdjacentElement('beforeend', S);
			}
			t_zeroForms__onRender(e, !1, function () {
	...
	if (
		(k.classList.add('t-input-error'),
		p.insertAdjacentElement('beforeend', k),
...
function t_zeroForms__createSelect(t, e, r, o) {
	...
	if (
		...
		(l.textContent = t.li_selfirstvar),
	...
	return (
		n.forEach(function (t, r) {
			...
			(o.value = t),
				(o.textContent = t),
				_ && (o.style.color = e.color),
				i && i === r + 1 && (o.selected = !0),
...
function t_zeroForms__createRadio(t, e, r, o, n, i, a) {
	...
	_ &&
		d.appendChild(t_zeroForms__createNameFieldForCheckbox(r, m, 'checkboxes')),
		d.appendChild(m);
	...
	return (
		s.forEach(function (s, l) {
			...
			(m.type = n),
				...
				_ || (m.name = r.name);
			var b = t.li_title || t.li_subtitle;
			if ((!_ && b && (m.ariaLabel = b), c && c === l + 1)) {
				m.checked = !0;
				var g = d.querySelector('.t-checkboxes__hiddeninput');
				g && (g.value = m.value);
			}
			r.require && m.setAttribute('data-tilda-req', '1'),
				f.push(m),
				u.insertAdjacentElement('beforeend', m);
			var v = t_zeroForms__createIndicator(n, e.inputelscolor, !1);
			u.insertAdjacentElement('beforeend', v);
			var F = document.createElement('span');
			if (
				((F.textContent = s),
				u.insertAdjacentElement('beforeend', F),
				s === t.li_ownvariant)
			) {
				var y = t_zeroForms__createStyleObjectForOwnAnswer(o, e),
					h = t_zeroForms__createOwnAnswer(m, u, t, y, r, i, a);
		...
		return (
			i.forEach(function (n, i) {
				...
				(c.type = _),
					...
					s.insertAdjacentElement('beforeend', c);
				var u = t_zeroForms__createIndicator('img-select', !1, {
					ratio: d,
					img: n.img,
				});
				if (
					(u.classList.add('t-bgimg'),
					u.classList.add('t-img-select__indicator'),
					t.li_img_fill_mode &&
						u.classList.add(
							't-img-select__indicator_fillmode-' + t.li_img_fill_mode
						),
					e.inputtitlecolor &&
						(u.style.borderColor = t_zeroForms__fromHEXtoRGBA(
							e.inputtitlecolor,
							0.1
						)),
					u.classList.add(d),
					u.setAttribute('data-original', n.img),
					(u.style.backgroundImage = 'url("' + n.img + '")'),
					s.insertAdjacentElement('beforeend', u),
					n.alt)
				) {
					var m = document.createElement('div');
					m.classList.add('t-img-select__text'),
						m.classList.add('t-text'),
						m.classList.add('t-text_xs'),
						(m.textContent = n.alt),
						e.inputtitlecolor && (m.style.color = e.inputtitlecolor),
...
function t_zeroForms__createUploadField(t, e, r) {
	...
	if ('published' !== window.tildamode) {
		...
		var a = o && '' === t.li_uwkey;
		return (
			(i.textContent = a ? 'Please set the key' : 'Upload button will be here'),
			i
		);
	}
	...
	t_zeroForms__appendMainSettingToField(c, e, 'hidden', ''),
		...
		(c.style.display = 'none'),
		o
			? (c.setAttribute('data-tilda-upwidget-key', t.li_uwkey || ''),
			  'y' === t.li_multiupl &&
					c.setAttribute('data-tilda-upwidget-multiple', '1'))
			: c.setAttribute('data-public-key', t.li_uckey || 'demopublickey'),
		l.insertAdjacentElement('beforeend', c);
	var d = o ? 'tilda-upwidget-1.1.min.js' : 'uploadcare-3.x.min.js';
	return (
		'uploadcare-3.x.min.js' !== d ||
			window.jQuery ||
			(d = 'uploadcare-3.x.full.min.js'),
		(o || (!o && !document.querySelector('script[src*="uploadcare-3.x"]'))) &&
			t_zeroForms__setScriptOrStyle(s + '-zero-form', d, '', 'script', !1),
		l
	);
}
...
function t_zeroForms__createQuantityRange(t, e, r, o) {
	...
	a.classList.add('t-range__value-txt'),
		a.classList.add('t-descr'),
		a.classList.add('t-descr_xxs'),
		(a.style.display = 'none'),
		n.insertAdjacentElement('beforeend', a);
	var s = document.createElement('div');
	s.classList.add('t-range__interval-txt-wrapper');
	var l = t_zeroForms__createRangeField(
			'min',
			r.inputtitlecolor,
			t.li_vmin || '0'
		),
		_ = t_zeroForms__createRangeField(
			'max',
			r.inputtitlecolor,
			t.li_vmax || '10'
		);
...
function t_zeroForms__createCalculation(t, e, r, o) {
	var n = document.createDocumentFragment(),
		i = document.createElement('input');
	t_zeroForms__appendMainSettingToField(i, r, 'hidden', 't-calc__hiddeninput'),
		(i.tabIndex = -1),
		(i.value = '0'),
		n.appendChild(i);
	var a = t_zeroForms__createWrapper([
		't-calc__wrapper',
		't-name',
		't-name_md',
	]);
	(a.style.color = e.color),
		(a.style.fontFamily = o.fontFamily),
		(a.style.fontSize = e.fontSize),
		(a.style.fontWeight = e.fontWeight),
		t_zeroForms__createCalcTextField(t.li_prefix, 'prefix', a);
	var s = document.createElement('span');
	if (
		...
		return n;
	if (t.li_prod_title) {
		var l = t_zeroForms__createHiddenField(
			t.li_prod_title,
			'prod_title',
...
function t_zeroForms__generateBtnStyles(t, e, r, o, n) {
	...
	l &&
		((d += ', '),
		(d +=
			c + '.uploadcare--widget__button.uploadcare--widget__button_type_open')),
		_ && ((d += ', '), (d += c + '.t-upwidget-container__button'));
	var m,
	...
	u &&
		...
		_ &&
			((p += c + '.t-upwidget-container__button '),
			(p +=
				'{background-image: ' +
				o.buttonbgcolor +
				'; background-color: transparent;}')));
	...
	if (
		...
		t_zeroForms__setScriptOrStyle(f, '', p, 'style', n),
		s)
	) {
		...
		y && y.parentElement && y.parentElement.removeChild(y),
			t_zeroForms__setScriptOrStyle(F, '', v, 'style', n);
	}
}
...
function t_zeroForms__createErrorBox(t, e) {
	...
	var o = document.createElement('div');
	o.classList.add('js-errorbox-all'),
		o.classList.add('t-form__errorbox-wrapper'),
	...
	n.classList.add('t-form__errorbox-text'),
		...
		['all', 'req', 'email', 'name', 'phone', 'string'].forEach(function (e) {
			...
			r.classList.add('t-form__errorbox-item'),
				...
				r.classList.add('js-rule-error-' + e),
				'all' !== e && 'string' !== e && (r.textContent = t['formerr' + e]),
...
function t_zeroForms__getBottomText(t, e, r, o, n) {
	...
	if (
		...
		d.classList.add('t-checkbox__labeltext'),
			(d.innerHTML = n),
...
function t_zeroForms__animateInputs(t, e, r, o) {
	...
	(i += '{position: relative; overflow: hidden;}'),
		e.inputcolor &&
			((i += n + '.t-input__vis-ph'), (i += '{color:' + e.inputcolor + ';}')),
		t_zeroForms__setScriptOrStyle(
			't-zero-form-anim-styles-' + r + '-' + o,
			'',
			i,
			'style',
			t
...
function t_zeroForms__setScriptOrStyle(t, e, r, o, n) {
	if (!document.getElementById(t)) {
		...
		r
			? (c.textContent = r)
			: ('script' === o
					? ((c.src = _ + '/js/' + e), (c.async = !0), (c.charset = 'utf-8'))
					: 'link' === o &&
					  ((c.href = _ + '/css/' + e), (c.rel = 'stylesheet')),
			  (c.onerror = function () {
		...
		var d = 'style' === o && n ? n.querySelector('.tn-atom') : null,
			u;
		('style' === o && d ? d : document.body).insertAdjacentElement(
			'beforeend',
			c
		);
	}
